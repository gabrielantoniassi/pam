...
void mul4x4(int boolean_mLHSisRowMajor, double* mLHS, double* mRHS, double* mResult)
{
        ...
        if (boolean_mLHSisRowMajor)
        {
                ...
                __vector double mLHSaux1 = vec_xl(0, mLHS);         // [a11 a12]
                __vector double mLHSaux2 = vec_xl(0, mLHS + 4);     // [a21 a22]
                mLHScol11 = vec_perm(mLHSaux1, mLHSaux2, GETCOL1);  // [a11 a21]
                mLHScol21 = vec_perm(mLHSaux1, mLHSaux2, GETCOL2);  // [a12 a22]

                // entao mLHScoli1 = [ai1 ai2]
                // entao mLHScoli2 = [ai3 ai4]
        ...
        // lendo o código acima eu entendi que:
        // mRHSrowi1 = [bi1 bi2]
        // mRHSrowi1 = [bi3 bi4]
        // vAuxLHSij = [aij aij]
        vec_xst(vec_add(
